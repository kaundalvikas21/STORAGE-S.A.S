...
const nextConfig = {
  ...
  // Placeholder photography host (content/images.ts). No `search` restriction: Unsplash URLs
  // carry sizing query params. Remove when the client's real sede photos land.
  images: {
