 ...
 *  pins, Autopista Norte larger with its permanent tag). lg only, like the homepage: below lg the
 *  cards that follow carry every address, and mobile never downloads the map chunk. */
export default function SedesHero() {
  return (
    <section aria-labelledby="sedes-h1" className="mx-auto max-w-site px-5 pb-10 pt-2 md:px-8 lg:px-10">
      ...
      <div className="mt-8 hidden h-[460px] lg:block">
        <SedeMap />
      </div>
    </section>
  );
